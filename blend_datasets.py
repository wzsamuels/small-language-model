...
def blend_and_shuffle(gutenberg_path, modern_path, output_path, gutenberg_weight=0.75):
...
blend_and_shuffle(
    gutenberg_path='training_data.jsonl', 
    modern_path='modern_training_data.jsonl', 
    output_path='master_training_data_75.jsonl',
...
blend_and_shuffle(
    gutenberg_path='training_data.jsonl', 
    modern_path='modern_training_data.jsonl', 
    output_path='master_training_data_50.jsonl',
...
blend_and_shuffle(
    gutenberg_path='training_data.jsonl', 
    modern_path='modern_training_data.jsonl', 
    output_path='master_training_data_25.jsonl',
